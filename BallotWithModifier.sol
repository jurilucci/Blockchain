...
contract Ballot {
    ...
    function register(address toVoter) public validStage(Stage.Reg) onlyBy(msg.sender){
    ...
    function winningProposal() public validStage(Stage.Done) view returns (uint8 _winningProposal) {
       ...
       //to avoid that 0 is shown as the result until anyone has voted yet
